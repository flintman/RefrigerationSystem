...
int main() {
    ...
    std::cout << "Defrost Coil Temperature: " << cfg.get("defrost.coil_temperature") << "°C\n";
    std::cout << "Temperature Setpoint Offset: " << cfg.get("setpoint.offset") << "°C\n";
